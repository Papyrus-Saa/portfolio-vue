...
<template>
  <div
    class="topLeftContent w-full  flex flex-col justify-around items-center px-4 text-center py-6"
  >
    <h3 class="mb-4 text-2xl text-center">Here do you will find the Pokémon's app</h3>
    <img
    ...
    <LinkButton>
      <a
        href="https://next-react-git-main-ramons-projects-67ad5b82.vercel.app/dashboard/main"
        target="_blank"
